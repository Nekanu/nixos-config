{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-8500d899-1c61-4f1c-967f-1fd4437b94ee" = [ ];
    ...
    configFile = {
      ...
      "dolphinrc"."PreviewSettings"."Plugins" =
        "audiothumbnail,blenderthumbnail,comicbookthumbnail,djvuthumbnail,ebookthumbnail,exrthumbnail,directorythumbnail,fontthumbnail,imagethumbnail,jpegthumbnail,kraorathumbnail,windowsexethumbnail,windowsimagethumbnail,mobithumbnail,opendocumentthumbnail,gsthumbnail,rawthumbnail,svgthumbnail,ffmpegthumbs";
      "dolphinrc"."VersionControl"."enabledPlugins" = "Git";
      "kactivitymanagerdrc"."activities"."8500d899-1c61-4f1c-967f-1fd4437b94ee" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "8500d899-1c61-4f1c-967f-1fd4437b94ee";
      ...
      "kdeglobals"."DirSelect Dialog"."DirSelectDialog Size" = "846,616";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{aa83bbf4-3c00-4c48-9187-1a7739f876a3}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{4383b4c1-f38e-4c4f-821d-fc136bf9513f}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{03dfc10a-3464-4c4f-ad8d-152bd622c811}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{8a992d2b-851a-4793-9e13-9b68b3185879}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{aed133b0-0734-4f4c-adf3-d84d7f9c9ec1}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{63497422-2513-4aac-bd78-e1d49bc32e0c}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{7e9861de-a384-471c-93e8-e7ff26c0b48b}";
      ...
      "kwinrc"."Desktops"."Id_1" = "84b7f5df-578c-491b-bfdc-5531fefe924f";
      "kwinrc"."Desktops"."Id_2" = "f5b3cc24-2c58-4c04-bcf1-5f11eddeeb1c";
      "kwinrc"."Desktops"."Number" = 2;
      "kwinrc"."Desktops"."Rows" = 1;
      "kwinrc"."Effect-windowview"."BorderActivateAll" = 9;
      "kwinrc"."NightColor"."Active" = true;
      "kwinrc"."NightColor"."LatitudeAuto" = 48.9219;
      "kwinrc"."NightColor"."LatitudeFixed" = 47.4;
      "kwinrc"."NightColor"."LongitudeAuto" = 8.4936;
      "kwinrc"."NightColor"."LongitudeFixed" = 9.47;
      "kwinrc"."NightColor"."Mode" = "Location";
      "kwinrc"."NightColor"."NightTemperature" = 3200;
      "kwinrc"."Plugins"."blurEnabled" = true;
      "kwinrc"."Plugins"."contrastEnabled" = true;
      "kwinrc"."Tiling"."padding" = 4;
      "kwinrc"."Tiling.88eab92d-88ac-5475-9873-1588f6e3bf06"."tiles" =
        "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.ec51c07a-8f73-52a0-a93f-c14271feb85a"."tiles" =
        "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrulesrc"."4857da2b-3005-4d78-8b07-e6f677d251ff"."Description" = "Window settings for firefox";
      "kwinrulesrc"."4857da2b-3005-4d78-8b07-e6f677d251ff"."above" = true;
      "kwinrulesrc"."4857da2b-3005-4d78-8b07-e6f677d251ff"."aboverule" = 3;
      "kwinrulesrc"."4857da2b-3005-4d78-8b07-e6f677d251ff"."title" = "Picture-in-Picture";
      "kwinrulesrc"."4857da2b-3005-4d78-8b07-e6f677d251ff"."titlematch" = 1;
      "kwinrulesrc"."4857da2b-3005-4d78-8b07-e6f677d251ff"."types" = 1;
      "kwinrulesrc"."4857da2b-3005-4d78-8b07-e6f677d251ff"."wmclass" = "firefox";
      "kwinrulesrc"."4857da2b-3005-4d78-8b07-e6f677d251ff"."wmclassmatch" = 1;
      "kwinrulesrc"."General"."count" = 1;
      "kwinrulesrc"."General"."rules" = 1;
      "plasma-localerc"."Formats"."LANG" = "de_DE.UTF-8";
      "plasma-localerc"."Translations"."LANGUAGE" = "en_US";
      "plasmarc"."PlasmaToolTips"."Delay" = 5;
